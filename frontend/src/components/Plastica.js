...
function Plastica() {
  ...
  return (
    <Container>
      <Typography variant="h3" gutterBottom>Plástica</Typography>
      <Typography variant="h6" gutterBottom>
        Explora el contenido de plástica para cada grado.
      </Typography>
      <Grid container spacing={4}>
        {cursos.length > 0 ? (
          ...
          <Grid item xs={12}>
            <Typography>No hay cursos disponibles para plástica.</Typography>
          </Grid>
        )}
      </Grid>
    </Container>
