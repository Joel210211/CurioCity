...
function Musica() {
  ...
  return (
    <Container>
      <Typography variant="h3" gutterBottom>Música</Typography>
      <Typography variant="h6" gutterBottom>
        Explora el contenido de música para cada grado.
      </Typography>
      <Grid container spacing={4}>
        {cursos.length > 0 ? (
          ...
          <Grid item xs={12}>
            <Typography>No hay cursos disponibles para música.</Typography>
          </Grid>
        )}
      </Grid>
    </Container>
